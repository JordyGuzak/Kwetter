...
/**
 * Created by jordy on 04/11/2017.
 */
//@Provider
//@PreMatching
public class CORSFilter implements ContainerResponseFilter {
    ...
    protected int corsMaxAge = 150000;
    protected Set<String> allowedOrigins = new HashSet<String>();

    public CORSFilter() {
        this.setAllowedMethods(ACCESS_CONTROL_ALLOW_METHODS_VALUE);
        this.setAllowedHeaders(ACCESS_CONTROL_ALLOW_HEADERS_VALUE);
        this.setExposedHeaders(ACCESS_CONTROL_ALLOW_HEADERS_VALUE);
        this.allowedOrigins.add(ACCESS_CONTROL_ALLOW_ORIGIN_VALUE);
    }
